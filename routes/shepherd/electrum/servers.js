...
module.exports = (shepherd) => {
  shepherd.mergeLocalKvElectrumServers = () => {
    if (shepherd.appConfig.spv &&
      ...
      try {
        let kvElectrumServersCache = fs.readFileSync(`${shepherd.safewalletDir}/kvElectrumServersCache.json`, 'utf8');
  ...
  shepherd.loadElectrumServersList = () => {
    if (fs.existsSync(`${shepherd.safewalletDir}/electrumServers.json`)) {
      const localElectrumServersList = fs.readFileSync(`${shepherd.safewalletDir}/electrumServers.json`, 'utf8');
  ...
  shepherd.saveElectrumServersList = (list) => {
    const electrumServersListFileName = `${shepherd.safewalletDir}/electrumServers.json`;
      ...
      if (!err) {
        ...
        const FsWrite = () => {
          return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
              shepherd.log(result);
              shepherd.log(`electrumServers.json file is created successfully at: ${shepherd.safewalletDir}`);
              shepherd.writeLog(`electrumServers.json file is created successfully at: ${shepherd.safewalletDir}`);
              resolve(result);
            }, 2000);
          });
        }
  ...
  shepherd.saveKvElectrumServersCache = (list) => {
    const kvElectrumServersListFileName = `${shepherd.safewalletDir}/kvElectrumServersCache.json`;
      ...
      if (!err) {
        ...
        const FsWrite = () => {
          return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
              shepherd.log(result);
              shepherd.log(`kvElectrumServersCache.json file is created successfully at: ${shepherd.safewalletDir}`);
              shepherd.writeLog(`kvElectrumServersCache.json file is created successfully at: ${shepherd.safewalletDir}`);
              resolve(result);
            }, 2000);
          });
        }
