...
export const _lang = {
  'EN': {
    ...
    'JUMBLR': {
      ...
      'IMPORTANT_FUNDS': '[IMPORTANT] Funds are processed in lot sizes 100 SAFE, 1000 SAFE, and 10,000 SAFE.',
      ...
      'WHEN_IT_TOTALS': 'When it totals to 100 SAFE, it will process to your SAFE Jumblr Address.',
    ...
    'ZCPARAMS_FETCH': {
      'DOWNLOADING_ZCASH_KEYS': 'Downloading Zcash keys (868 mb). This can take a while depending on your connection',
      'BOTH_KEYS_VERIFIED': 'Both Zcash param keys are downloaded and verified! Please restart your Wallet now!',
      ...
      'ZCPARAMS_FETCH': 'ZCash Sprout Key Loader',
